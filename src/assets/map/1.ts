...
export default {
  ...
  map: [
    ...
    [Blocks.baseBlock, Blocks.null, Blocks.baseUndeployBlock, Blocks.baseBlock, Blocks.baseUndeployBlock, Blocks.enemyHome, Blocks.baseHighUndeployBlock, Blocks.baseHighUndeployBlock, Blocks.baseUndeployBlock],
